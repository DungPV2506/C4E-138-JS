/*
Cho dữ liệu về users:
Source: https://drive.google.com/file/d/14SKWEUz8ClmBppOF_myDNR4k2QB8-ykI/view?usp=sharing
Mỗi user gồm: id, first_name, last_name, email, password.
Cho dữ liệu về posts:
Source: https://drive.google.com/file/d/14SRSaVAzgzcj6IhctfOD_OyHJ2h2vDRf/view?usp=sharing
Mỗi post gồm: id, title, content, image, created_at, updated_at, user_id.
...
// if (email === "example@gmail.com" && password === ""){
//   alert("ok");
// }else if (email && password) {
//   // Tìm kiếm user trong dữ liệu người dùng
//   const users = [
//     { id: 1, email: "test1@gmail.com", password: "123456", fullName: "Nguyễn Văn A" },
//     { id: 2, email: "test2@gmail.com", password: "654321", fullName: "Trần Thị B" },
//     { id: 3, email: "test3@gmail.com", password: "789456", fullName: "Lê Thị C" }
//   ];

//   const user = users.find(user => user.email === email && user.password === password);

//   // Hiển thị thông tin phù hợp trên màn hình
//   if (user) {
...
//   }
// }else{
//   alert("email hoac mk sai:")
// }

// Kiểm tra xem email và mật khẩu nhập vào có đủ hay không

// let keyword = prompt("moi ban nhap thong tin:");
...
let posts = [{
  ...
  "content": "Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh. In quis justo. Maecenas rhoncus aliquam lacus.",
  "image": "http://dummyimage.com/100x100.png/ff4444/ffffff",
  "user_id": 3,
  ...
  "content": "Curabitur convallis. Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero. Nullam sit amet turpis elementum ligula vehicula consequat.",
  "image": "http://dummyimage.com/100x100.png/5fa2dd/ffffff",
  "user_id": 6,
  ...
  "content": "In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo. Aliquam quis turpis eget elit sodales scelerisque.",
  "image": "http://dummyimage.com/100x100.png/dddddd/000000",
  "user_id": 4,
  ...
  "id": 34,
  "title": "Blue shark",
  "content": "Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros. Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat. In congue. Etiam justo. Etiam pretium iaculis justo.",
  "image": "http://dummyimage.com/100x100.png/cc0000/ffffff",
  "user_id": 10,
...
// Câu 3: Nhập vào keyword. Hãy in ra những users có họ và tên hoặc email chứa keyword. Mỗi users hiển thị id, họ và tên, email

// let keyword = prompt("Mời bạn nhập keyword");
// for(let user of users){
//   let inforUser = user.id +" " + user.first_name +" "+ user.email;
//   if(inforUser.includes(keyword)){
...
Câu 5. Xây dựng chức năng xem chi tiết 1 post.
...
hị danh sách các posts, mỗi post bao gồm ID, title, ngày tạo, họ và tên người tạo
*/
/*
let keyword = Number(prompt("Hãy nhập ID từ bàn phím:"));
let check = false;
...
if(keyword == null || isNaN(keyword)){
  console.log("DS tất cả các post:");
}
*/


// Câu 4: Xây dựng chức năng xem danh sách posts
// Hiển thị danh sách các posts, mỗi post bao gồm ID, title, ngày tạo, họ và tên người tạo.
for(let post of posts){
  let user = getUserById(post.user_id);
  console.log(post.id, post.title, post.created_at, post.first_name + " "+ user.last_name);
}
